...
smd(
  ...
  async (m) => {
    try {
      ...
      // Define the API URL
      const apiUrl = `https://giftedapis.us.kg/api/ai/gpt4?q=${encodeURIComponent(query)}&apikey=gifteddevskk`;
...
smd(
  ...
  async (m, query) => {
    try {
      ...
      const apiUrl = `https://giftedapis.us.kg/api/ai/sd?prompt=${encodeURIComponent(query)}&apikey=gifteddevskk`;
...
smd(
  ...
  async (m) => {
    try {
      ...
      // Define the API URL
      const apiUrl = `https://giftedapis.us.kg/api/ai/luminai?query=${encodeURIComponent(query)}&apikey=gifteddevskk`;
      const response = await fetch(apiUrl);
...
smd(
  ...
  async (m) => {
    try {
      ...
      const apiUrl = `https://giftedapis.us.kg/api/ai/geminiai?q=${encodeURIComponent(query)}&apikey=gifteddevskk`;
      const response = await fetch(apiUrl);
...
smd(
  ...
  async (m) => {
    try {
      ...
      // Define the new API URL
      const apiUrl = `https://giftedapis.us.kg/api/ai/davinci?q=${encodeURIComponent(query)}&apikey=gifteddevskk`;
      const response = await fetch(apiUrl);
...
smd(
  ...
  async (m) => {
    try {
      ...
      // Define the new API URL
      const apiUrl = `https://giftedapis.us.kg/api/ai/simsimi?query=${encodeURIComponent(query)}&apikey=gifteddevskk`;
      const response = await fetch(apiUrl);
...
smd(
  ...
  async (m, query) => {
    try {
      ...
      // Construct the API URL with the provided query
      const apiUrl = `https://giftedapis.us.kg/api/ai/text2img?prompt=${encodeURIComponent(query)}&apikey=gifteddevskk`;
