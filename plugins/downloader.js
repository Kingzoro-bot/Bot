 ...
 smd(
  ...
  async (m, username) => {
    try {
      ...
      const apiUrl = `https://giftedapis.us.kg/api/stalk/igstalk?username=${encodeURIComponent(
        username
      )}&apikey=gifteddevskk`;
...
smd(
  ...
  async (m, channelUrl) => {
    try {
      ...
      const apiUrl = `https://giftedapis.us.kg/api/stalk/wachannel?url=${encodeURIComponent(
        channelUrl
      )}&apikey=gifteddevskk`;
...
smd(
  ...
  async (m, username) => {
    try {
      ...
      const apiUrl = `https://giftedapis.us.kg/api/stalk/gitstalk?username=${encodeURIComponent(
        username
      )}&apikey=gifteddevskk`;
      const response = await axios.get(apiUrl);
...
smd(
  ...
  async (m, ipAddress) => {
    try {
      ...
      const apiUrl = `https://giftedapis.us.kg/api/stalk/ipstalk?address=${encodeURIComponent(
        address
      )}&apikey=gifteddevskk`;
      const response = await axios.get(apiUrl);
...
smd({
  ...
  try {
    ...
    const apiUrl = `https://giftedapis.us.kg/api/download/facebook?url=${videoUrl}&apikey=gifteddevskk`;
...
smd({
  ...
  try {
    ...
    const apiUrl = `https://giftedapis.us.kg/api/download/tiktok?url=${videoUrl}&apikey=gifteddevskk`;
...
smd({
  ...
  try {
    ...
    const apiUrl = `https://giftedapis.us.kg/api/download/pinterestdl?url=${_0x4ec99f}&apikey=gifteddevskk`;
