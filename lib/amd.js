...
// Send the image from './alya.jpg'
await message.client.sendMessage(message.jid, {
    image: { url: './alya.jpg' },
    caption: '👑✨ *${Config.botname} has awakened!* ✨👑'
});

// Send a short bold connection message
await message.client.sendMessage(message.jid, {
    text: '*👑 Royal Systems Online!*',
    options: { detectLinks: false }
});

// Play the audio from './alya.mp3'
await message.client.sendMessage(message.jid, {
    audio: { url: './alya.mp3' },
    mimetype: 'audio/mpeg'
});
